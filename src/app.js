    ...
    console.log('DEBUG (Local ENV): process.env.DB_PASSWORD =', process.env.DB_PASSWORD ? '*****' : 'UNDEFINED/EMPTY');
    ...
    console.log('DEBUG (Railway ENV): process.env.MYSQL_PASSWORD =', process.env.MYSQL_PASSWORD ? '*****' : 'UNDEFINED/EMPTY');
    ...
    console.log('DEBUG (Railway ENV): process.env.MYSQL_URL =', process.env.MYSQL_URL ? '***** (URL exists)' : 'UNDEFINED/EMPTY'); // Tambahkan ini
    ...
    if (process.env.MYSQL_URL) {
      ...
      console.log('Using MYSQL_URL for database connection.'); // Debugging
    } else {
      // Jika tidak ada (lokal), fallback ke variabel DB_* dari .env
      dbConfig = {
        host: process.env.DB_HOST,
        user: process.env.DB_USER,
        password: process.env.DB_PASSWORD,
        database: process.env.DB_NAME,
        port: process.env.DB_PORT ? parseInt(process.env.DB_PORT) : 3306 // Pastikan port di-parse
      };
      console.log('Using DB_* variables for database connection.'); // Debugging
    }
